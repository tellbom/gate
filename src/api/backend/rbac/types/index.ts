...
export interface AdminItem {
    ...
    /** 是否为当前 X-Project 的超管 */
    isSuper: boolean
    grants?: Record<string, { groups?: string[]; super?: boolean }>
}
...
export interface GlobalProjectListResult {
    list: string[]
    total: number
}

export interface ProjectWriteResultItem {
    project: string
    success: boolean
    skipped: boolean
...
export interface ProjectWriteResult {
    results: ProjectWriteResultItem[]
    successCount: number
    failureCount: number
}

export interface GlobalUserGrantForm {
    username?: string
    targetProjects: string[]
    isSuper?: boolean | null
}

export interface GlobalGroupMemberForm {
    userid: string
